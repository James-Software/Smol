...
type LinkBarProps = {
  // Update the type to accept the string argument
  ...
  return (
    <div className="relative mt-24 w-2/5">
        ...
        <button 
          ...
          className="absolute top-1.5 bottom-1.5 right-1.5 flex items-center text-[#0a0a0a] font-semibold cursor-pointer bg-amber-600 pl-6 pr-6 rounded-md"
        >
          Enter
        </button>
    </div>
